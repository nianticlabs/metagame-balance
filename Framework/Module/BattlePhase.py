...
class BattlePhase:
    ...
    def __init__(self, c0: Competitor, c1: Competitor, t0: PkmTeam, t1: PkmTeam, meta_data: MetaData):
        self.c0 = c0
        self.c1 = c1
        self.t0 = t0
        self.t1 = t1
    ...
    def run(self):
        ...
        while not be.match_completed():
            be.run_step()
            oth0 = OponentTeamHyphotesizing(self.c0.team_hyphotesizer, self.meta_data, opp0, None)
            oth1 = OponentTeamHyphotesizing(self.c1.team_hyphotesizer, self.meta_data, opp1, None)
